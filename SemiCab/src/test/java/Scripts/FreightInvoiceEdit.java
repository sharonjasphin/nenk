...
public class FreightInvoiceEdit extends Base{
	...
	public void validateInvoiceCreation() throws Throwable {
		...
		System.out.println("Freight InvoiceLine Charge==>"+charge);
		System.out.println("Freight Invoice Amount Charge==>"+InvoiceAmount);
		test.log(LogStatus.PASS, "Freight InvoiceLine Editted");
